...
const addManualUPIPaymentRequesttwo = async (req, res) => {
  try {
    ...
    const callback_url = "https://real-cash365.club/watchpays-callback";
...
const addBondPayPaymentRequest = async (req, res) => {
    try {
        ...
        const requestBody = {
            ...
            callback_url: "https://real-cash365.club/callback/bondpay",
            extra: 0
        };
...
const callbackfromgateway = async (req, res) => {
    ...
    try {
        ...
        const resdata = await axios.post("https://real-cash365.club/api/webapi/admin/rechargeDuyet", {
            id: rows[0]?.id,
            type: "confirm"
        })
