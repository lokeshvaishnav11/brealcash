      ...
      >
        ...
        {!isAuthenticated ? <div className="d-flex align-items-center gap-2 fw-bold small">
          ...
          >
            ...
            <span class=" d-flex align-items-center justify-content-center bg-white text-black rounded-circle" style={{ width: "16px", height: "16px", fontSize: "10px" }}>R$</span> {userInfo ? userInfo?.wallet : "0"}
