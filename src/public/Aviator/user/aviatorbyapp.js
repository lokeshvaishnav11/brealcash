...
//                                         `+Math.round(data[$i].cashout_multiplier*data[$i].amount)+`R$
//                                     </div>
//                                 </div>
//                                 `);
//                                     }
...
const nextcrash = async () => {
        try {
            const response = await $.ajax({
                url: 'https://real-cash365.club/nextcrash', // Adjust the endpoint as per your backend route
                method: 'GET',
                dataType: 'json'
            });
...
nextcrash();
    ...
    setTimeout(() => {
        ...
        //                             </div>
        //                             <div class="column-4 fw-normal">
        //                                 ${parseFloat(betHistory[i].crash) > 1 ? (parseFloat(betHistory[i].crash) * betHistory[i].amount) + 'R$' : ''}
        //                             </div>
        //                         </div>
        //                     `);
        //             }
        ...
        function handleCrash(msg) {
            ...
            // Check if the crash value is greater than or equal to 'a'
               ...
               resetTotalWinning();
                ...
                //                         </div>
                //                         <div class="column-4 fw-normal">
                //                             ${parseFloat(bet.crash) > 1 ? (parseFloat(bet.crash) * bet.amount) + 'R$' : ''}
                //                         </div>
                //                     </div>
                //                 `);
                //             });
